...
import moduloSeguridad.Controller.RecuperarContraseñaController;
...
//		this.primaryStage.set
	...
	public void mostrarVentanaRecuperarContraseña() {
		try {
			primaryStage.close();
			FXMLLoader loader1 = new FXMLLoader(Aplicacion.class.getResource("view/recuperarContraseña.fxml"));
			AnchorPane anchorPane2=loader1.load();
			Scene scene2= new Scene(anchorPane2);
			RecuperarContraseñaController reContraseñaController = loader1.getController();
			reContraseñaController.setAplication(this);
